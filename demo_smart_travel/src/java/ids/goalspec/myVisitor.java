...
import ids.goalspec.model.AbstractGoalEntity;
import ids.goalspec.model.ActorEntity;
import ids.goalspec.model.Entity;
import ids.goalspec.model.ManyActorsEntity;
import ids.goalspec.model.ManyGoalsEntity;
import ids.goalspec.model.SocialGoalEntity;
import ids.goalspec.model.Specification;
import ids.goalspec.model.SystemGoalEntity;
import ids.goalspec.model.condition.ANDCondition;
import ids.goalspec.model.condition.Condition;
import ids.goalspec.model.condition.NOTCondition;
import ids.goalspec.model.condition.ORCondition;
import ids.goalspec.model.condition.event.DelayEvent;
import ids.goalspec.model.condition.event.WhenStateEvent;
import ids.goalspec.model.state.ANDState;
import ids.goalspec.model.state.MessageIncomeState;
import ids.goalspec.model.state.MessageOutcomeState;
import ids.goalspec.model.state.NOTState;
import ids.goalspec.model.state.ORState;
import ids.goalspec.model.state.State;
import ids.goalspec.model.state.term.AtomTerm;
import ids.goalspec.model.state.term.ListTerm;
import ids.goalspec.model.state.term.NumericTerm;
import ids.goalspec.model.state.term.StringTerm;
import ids.goalspec.model.state.term.StructureTerm;
import ids.goalspec.model.state.term.TermPredicate;
import ids.goalspec.model.state.term.VariableTerm;
