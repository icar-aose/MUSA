...
public class HTTPProxy extends Artifact implements Observer
{
	...
	{
		EntryPointTable table = new EntryPointTable();
		EntryPointEntity entity = null;
		try {
			entity = (EntryPointEntity)table.findOneBy("service", "approve_billing");
		...
		String user = "user";
		String role = "occp_user";
		
		System.out.println("Sending request...");
		signal("http_request", 	0, session, agent, service, user, role);
	}
