...
{
	private final String json_app_secret_key_fname = "/home/davide/musa_google_application_keys.json";
    ...
    public Object execute(TransitionSystem ts, Unifier un, Term[] args) throws Exception 
    {
		...
		try 
		{
			...
			System.out.println("ECCOMI. File da uploadare: "+fname);
			Thread.sleep(6000);
		...
		/*GoogleDrive gd = new GoogleDrive();
		gd.set_username("davide");
		gd.set_data_store_dir(System.getProperty("user.home") + File.separator + ".store/fileUpload");
		
		
		try 
		{
			gd.set_app_secret_key_json_file(new FileInputStream("/home/davide/musa_google_application_keys.json"));
			gd.upload_file("/home/davide/prova.pdf", true);
			
			gd.set_user_as_reader_for_uploaded_file("sultanofswing.90@gmail.com");
		} 
		catch (IOException e) 
		{
			e.printStackTrace();
