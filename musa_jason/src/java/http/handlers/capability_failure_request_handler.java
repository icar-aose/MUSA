...
public class capability_failure_request_handler extends Observable implements HttpHandler 
{	
    @Override
    public void handle(HttpExchange t) throws IOException 
    {
    	Server.request_type = MUSA_HTTP_REQUEST.SET_CAPABILITY_FAILURE;				//Set the request type
    	...
    	String cap_name = json_message.getString("capability_failure");				//Get the capability name
    	
        String response = "capability_failure ["+cap_name+"] ok";					//prepare and send the response
