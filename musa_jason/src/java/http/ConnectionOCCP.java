...
public class ConnectionOCCP extends Connection
{
	private static JSONArray product_message;
	private static HashMap<String,String> param_table = new HashMap<String,String>();
	
	public ConnectionOCCP(Socket connection) 
	{
		super(connection);
		readMessage();
	} 
	 ...
	 * @param json_message
	 */
	private void parse_params(JSONObject json_message)
	{
	 ...
	 * @param json_message
	 */
	private void parse_order_data(JSONObject json_message)
	{
	 ...
	 * @param json_message
	 */
	private void parse_user_data(JSONObject json_message)
	{	
		if (json_message.has("id_utente") && !param_table.containsKey("id_utente"))
			param_table.put("id_utente", json_message.getString("id_utente"));
	...
	{
		ConnectionOCCP.product_message = product_message;
	}
